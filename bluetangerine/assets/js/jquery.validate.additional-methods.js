...
$.validator.addMethod( "creditcardtypes", function( value, element, param ) {
	...
	if ( validTypes & 0x0002 && /^(4)/.test( value ) ) { // Visa
		...
		console.log("visa value="+ value.length);
...
$.validator.addMethod( "CanStates", function( value, element ) {

	var CanStateCodes = [ "AB","BC","MB","NB","NF","NL","NS","NT","NU","ON","PE","QC","SK","YT" ];

	return ($.inArray(value.toUpperCase(), CanStateCodes) !== -1);
}, "The specified Canadian State is invalid" );

$.validator.addMethod( "USStates", function( value, element ) {

	var USStateCodes = ["AA","AE","AK","AL","AP","AR","AS","AZ","CA","CM","CO","CT","CZ",
						 "DC","DE","FL","FM","GA","GU","HD","HI","HO","IA","ID","IL","IN",
					     "KS","KY","LA","MA","MD","ME","MH","MI","MN","MO","MP","MS","MT",
						 "NC","ND","NE","NH","NJ","NM","NV","NY","OH","OK","OR","PA","PR",
						 "PW","RI","SC","SD","TN","TX","UT","VA","VI","VT","WA","WI","WV","WY" ];

	return ($.inArray(value.toUpperCase(), USStateCodes) !== -1);
